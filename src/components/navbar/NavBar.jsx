                ...
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            <div className="flex flex-shrink-0 items-center">
                                <img className="h-10 w-auto hidden md:inline" src={logo} alt="Your Company"/>
                            </div>
                                ...
                                >
                                    ...
                                    {me && (
                                        <div className="bg-gradient-to-tl from-sky-500 to-sky-800 sm:px-8 px-2 py-6">
                                            ...
                                            <div
                                                className="flex justify-between items-center mt-3 font-bold text-white">
                                                <button
                    ...
                    {isModalOpen && (
                        <div className="fixed inset-0 flex items-center px-3 justify-center z-50">
                            <div
                                className="modal bg-white rounded-xl lg:w-1/3 sm:w-2/3  w-full overflow-hidden shadow-2xl">
                                <div className="">
                                    <div
                                        className="bg-slate-200 py-8  flex flex-col justify-center items-center relative">
                                        <i
                                    ...
                                    <div
                                        className="bg-gradient-to-tl w-full from-sky-500 to-sky-800 md:px-8 px-3 md:py-6 py-2">
                                        <div className=" font-bold text-black text-[1.1rem]">
                                            <p className="opacity-50 pb-0 mb-0 mt-2">{t("addclient3")}</p>
                                            <input
                                                type="text"
