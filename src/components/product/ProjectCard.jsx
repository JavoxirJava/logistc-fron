    ...
    return (
        <div
            ...
            <div className='card-col w-full '>
                <div className='h-8/12 card-col-row w-full flex xl:flex-row sm:flew-row flex-col media-product h-max'>
                    <div className='xl:w-[22%] w-full flex justify-between h-max'>
                        <div className='w-50'>
