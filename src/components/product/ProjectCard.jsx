...
function ProjectCard({className, projects, openEdit, setProductObj}) {
            ...
            <div className='card-col w-11/12 pt-2 ps-2'>
                <div className='h-8/12 card-col-row w-full flex media-product'>
                    <div className='sm:w-[22%]'>
                       ...
                       <p className='font-bold'>{projects ? projects.productId : 0}</p>
                    </div>
                    ...
                    <div className='sm:w-[26%]'>
                        ...
                        <p className='font-bold'>{projects ? projects.productName : "Iphone"}</p>
                    </div>
                </div>
                <div className='h-3/6 card-col-row w-full flex media-product'>
                    ...
                    <div className='sm:w-[18%] ps-1'>
                        ...
                        <p className='font-bold'>{projects ? projects.measureCount + " " + projects.measure : "No location"}</p>
                    </div>
                    <div className='sm:w-[18%] ps-1'>
                        <p className='opacity-70'>{t("card7")}</p>
                        <p className='font-bold'>{projects ? projects.owner : "No owner"}</p>
                    </div>
                </div>
            </div>
