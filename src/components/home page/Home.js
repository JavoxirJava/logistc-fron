  ...
  return (
    <>
      ...
      <div className="w-full">
        <div id="1" className="grid grid-cols-3 ps-20 pt-10">
          {/* <div> */}
          <div
        ...
        <div id="2" className="mt-20 pt-5">
          ...
          <div
            id="3" className="text-5xl font-semibold tracking-wider"
        ...
        <div id="4" className="back-img ps-32 pt-10 mt-20">
          <div
            className="flex"
          ...
          >
            ...
            />
            <h1
              className="text-5xl block font-semibold font-sans tracking-wider text-white"
